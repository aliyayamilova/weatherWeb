...
def centered_container(output):
    return style(output, list_container_style)


def font_second(output):
    return style(output, second_text_style)


def cell_container(output):
    return style(output, cell_container_style)


def margin_button_container(output):
    return style(output, margin_button)